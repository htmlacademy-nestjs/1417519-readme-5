...
export abstract class BaseMongoRepository<
  EntityType extends Entity<EntityIdType>,DocumentType extends Document>
  ...
  public async findAll(): Promise<EntityType[]> {
    ...
    return documents.map(this.createEntityFromDocument.bind(this));
  }
  ...
  public async save(entity: EntityType): Promise<EntityType> {
    ...
    entity.id = newEntity._id.toString();return entity;
  }
